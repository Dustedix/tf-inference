...
PATH_TO_CKPT = MODEL_NAME + 'inference_graph_10k/saved_model/saved_model.pb'

# List of the strings that is used to add correct label for each box.
PATH_TO_LABELS = os.path.join('data', 'Vehicle_label_map.pbtxt')
...
for file in tar_file.getmembers():
  ...
  if 'inference_graph_10k/saved_model/saved_model.pb' in file_name:
